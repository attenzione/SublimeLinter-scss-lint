...
Once scss-lint is installed, you can proceed to install the SublimeLinter-scss plugin if it is not yet installed.
...
1. When the plugin list appears, type `linter scss`. Among the entries you should see `SublimeLinter-scss`. If that entry is not highlighted, use the keyboard or mouse to select it.
